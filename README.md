...
2. Navigate to your chat server project, e.g. `stud-syspr-ss2021/group01/chat`.
...
6. Use `git clone`, e.g.: `git clone git@fbe-gitlab.hs-weingarten.de:stud-syspr-ss2021/group01/chat.git`
