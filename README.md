...
2. Navigate to your chat server project, e.g. `stud-syspr-ws2020/group01/chat`.
...
6. Use `git clone`, e.g.: `git clone git@fbe-gitlab.hs-weingarten.de:stud-syspr-ws2020/group01/chat.git`
