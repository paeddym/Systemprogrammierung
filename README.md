...
2. Navigate to your chat server project, e.g. `stud-syspr/2022-ws/g01/chat`.
...
6. Use `git clone`, e.g.: `git clone git@fbe-gitlab.hs-weingarten.de:stud-syspr/2022-ws/g01/chat.git`
